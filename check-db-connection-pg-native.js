...
async function checkDbConnectionPgNative() {
  ...
  try {
    console.log("Intentando conectar directamente a la base de datos usando pg nativo...")
    ...
    console.error("Error al conectar directamente a la base de datos usando pg nativo:", error)
...
module.exports = checkDbConnectionPgNative
